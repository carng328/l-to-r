...
$(function getHuffPost() {
        ...
        $.queryYQL(statement, "json", undefined, function (data) {
          ...
          $("#col1").append("<h4 id='huffingtonpost'> Published by Fox News <br/>"  + firstObjectHuffPost.pubDate + "</h4>"); 
...
$(function getFoxNews() {
        ...
        $.queryYQL(statement, "json", undefined, function (data) {
          ...
          $("#col2").append("<h4 id='fox'> Published by Fox News <br/>"  + firstObjectFoxNews.pubDate + "</h4>"); 
